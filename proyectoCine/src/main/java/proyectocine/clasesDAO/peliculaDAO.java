...
public class peliculaDAO implements DAO<Pelicula, Integer> {
    ...
    public void cargerPeliculasFake() {
        ...
        add(new Pelicula(contador, 0, "Guason 2: Folie a Deux", "Secuela de Guasón (2019), de nuevo con Phoenix como Arthur Fleck, y que muestra su relación con el personaje de Harley Quinn, interpretado por Lady Gaga.", "no", "01/01/2025", "Todd Phillips", EstadoPelicula.proximamente));
